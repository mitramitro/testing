...
var cat_desc='';
	...
	*/
	...
	function deleteDealRecord(dId){
		str= 'deleteHotel.php?action=delDeal&dId=';
		val = confirm('Are you sure you want to delete this Record?');
	
		if(val){
			document.location.href=str+dId;
		}
	}
	function deleteBidRecord(IId){
		str= 'deleteHotel.php?action=delBid&IId=';
		val = confirm('Are you sure you want to delete this Record?');
	
		if(val){
			document.location.href=str+IId;
		}
	}