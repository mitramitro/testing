...
<!-- ------------pop-up-code starts here------------->
 <div id="popup" >
    ...
    width: 473px;">
       ...
       <input name="username" id="username1" type="text" class="enter_middle_bg" value="Username" onfocus="if(this.value=='Username'){this.value='';}" onblur="if(this.value==''){this.value='Username';}" />
        ...
        <div class="enter_left_bg"></div>
       <input name="password" id="password1" type="text" class="enter_middle_bg" value="Password" onfocus="if(this.value=='Password'){this.value='';}" onblur="if(this.value==''){this.value='Password';}" />
		<div class="enter_right_bg"></div>
        </div>
        
        <div class="clear"></div>
          <p style="float:left; width:310px;padding-top: 7px;"><input type="checkbox" name="remember" id="remember"  value="1" <?php if($checked=='1') { echo 'checked'; }?>/>	
...
//
//	if(($("#username1").val() == "") || ($("#username1").val() == "Username") || (($("#password1").val() == "Password" )|| ($("#password1").val() == "" )))
//	  {
