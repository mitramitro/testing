...
<div class="whole-pennel-pass">
 <div id="UserManage">Manage Subscriber List</div>
...
$date_subscribe=$value->date_subscribe;
$status = $value->status;

$this->table->add_row($i,$UserEmailAddress,
anchor('Newsletter/subscriberstatus/'.$news_id.'/'.$status,$status),$date_subscribe,anchor('Newsletter/DeleteSubscriber/'.$news_id,'Delete'));
}
