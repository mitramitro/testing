<h2 style="border-bottom:1px solid #717171;color: #1F77B6;font-family: Times New Roman;font-size: 17px; margin-bottom:20px; ">Product List</h2>
<?php if ($message) { ?>
<div style="color: #F00;font-size: 15px;height: 30px;width: 200px;"><?php echo $message; ?></div>
<?php }?>
