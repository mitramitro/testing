...
<div  style="border: 1px solid #333333;height: auto;padding: 4px 0 7px;width:790px;">
 <?php
 $tmpl = array (
      
					  'table_open'          => '<table border="0" cellpadding="5px" cellspacing="2" width="790px" height="auto" class="ProdList">',
                    ...
                    'row_alt_start'       => '<tr>',
                    'row_alt_end'         => '</tr>',
                    'cell_alt_start'      => '<td class="ShowData" style="width:20%">',
                    'cell_alt_end'        => '</td>',
...
$this->table->set_heading('Sr No.','Product Name','Image Preview','View');
...
$this->table->add_row($i,$productName,"<div class='viewport'>".'<a class="fancybox" data-fancybox-group="gallery" href="'.$path.$imageName.'">'.img($image_properties).'</a>'."</div>",

'<a class="fancybox" data-fancybox-group="gallery" href="'.$path.$imageName.'">'.'Preview'.'</a>');
