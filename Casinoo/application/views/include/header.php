...
width:102px;height:38px;
 ...
 <div class="logo">
 <a href="#"><img src="<?php echo base_url();?>images/logo.png" width="256" height="79"  alt="img" border="0"/></a></div>
...
<?php endif; ?>
  ...
  ?>
      ...
      <?php if ($this->authentication->is_signed_in()) : ?>
      <?php echo sprintf(lang('website_welcome_username'), '<strong>'.$account->username.'</strong>'); ?></li>
      <div class="create-acc-text"> <?php echo anchor('login/logout','Log Out')?> </div>
      <?php else : ?>
...
<!-- <div class="create-acc-text"><a id="my-button" href="#">Sign In</a> or <a id="my-Registrationbtn" href="#">Register</a></div>-->
 ...
 <div class="clear"></div>
  ...
  <ul id="navmenu-h">
         <li><?php echo anchor('casino/view/mypage','Home')?></li>
         <li><?php echo anchor('casino/view/bingo','Bingo')?></li>
         <li><?php echo anchor('casino/view/poker','Poker')?></li>
         <li><?php echo anchor('casino/view/scratch_cards','Scratch Cards')?></li>
         <li><?php echo anchor('casino/view/new_casino','New Casino')?></li>
         <li><?php echo anchor('casino/view/usa_play','USA Play')?></li>       
       
        
         <li><?php echo anchor('casino/view/bingo','Reviews')?>
          <ul>
