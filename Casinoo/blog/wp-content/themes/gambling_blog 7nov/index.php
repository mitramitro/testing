...
<?php get_header(); ?>
            ...
            <div class="main_blog_image_cont"><img src="<?php bloginfo('template_directory'); ?>/images/blog_image.png" alt="" width="114" height="97" border="0" /></div>
            <div class="main_blog_heading_cont">
            <h2>Staying Safe on a Business Trip Abroad</h2>
            <div class="clear"></div>
            <h3>Posted on December 13, 2011 by <span><a href="#">admin</a></span></h3>
            <p>Business travelers are usually given the luxury of safer travels than those who are winging it when traveling solely for pleasure. After all, most companies have established connections in countries where frequent travel is expected. However, it can still be …</p>
            <h4><a href="#">Read Full Entry</a>  |  <a href="#">No comments yet</a></h4>
            
            </div>
            
            </div>
            <div class="main_blog_cont pad-1">
            <div class="main_blog_image_cont"><img src="<?php bloginfo('template_directory'); ?>/images/blog_image.png" alt="" width="114" height="97" border="0" /></div>
            <div class="main_blog_heading_cont">
            <h2>Staying Safe on a Business Trip Abroad</h2>
            <div class="clear"></div>
            ...
            <div class="view_more_btn"> View More &raquo;</div>
