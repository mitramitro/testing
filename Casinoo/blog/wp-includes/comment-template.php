...
function comment_form( $args = array(), $post_id = null ) {
	...
	$defaults = array(
		...
		'comment_field'        => '<p class="comment-form-comment"><div class="co"><label for="comment">' . _x( 'Comment:', 'noun' ) . '</label>' . ( $req ? '<span class="required">*</span>' : '' ) .
...
#author {
    background: url("./wp-includes/images/searchbg.gif") repeat-x scroll 0 0 transparent;
...
#comment {
   background: url("./wp-includes/images/textareabg.gif") repeat-x scroll 0 0 #A3A3A3;
    border: 1px solid #FFFFFF;
    color: #191919;
   
    font: 13px Lucida Sans,Helvetica,Arial,Sans-Serif;
    height: 126px;
    margin-bottom: 20px;
    overflow: auto;
    padding: 7px 5px 7px 10px;
...
.comment_btn{ 
background-image:url(http://localhost/casino/wordpress/wp-content/themes/gambling_blog/images/post_com_btn.png);
width:111px;
height:32px;
border:none;
}
				...
				<?php else : ?>
                    ...
                    <span style="font-family:'Century Gothic'; font-size:15px; color:#A30909; font-weight:bold;">
                    Leave a Reply</span>
					...
					<?php /*?>	<?php echo $args['comment_notes_after']; ?><?php */?>
						<p class="form-submit">
							<input class="comment_btn" name="submit" type="submit" id="<?php echo esc_attr( $args['id_submit'] ); ?>" value="" />
