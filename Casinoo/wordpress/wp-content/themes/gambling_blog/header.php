...
<?php $base_url	= 'http://localhost/casino/'; ?>
 ...
 <form action="<?php echo site_url("login/go")?>" id="logForm" method="post"> 
    ...
    &nbsp; <label for="remember">Remember Me</label>
      ...
      <!--  <input type="submit" value="Login" name="login" class="submit" />
        ...
        <a href="<?php echo base_url().'index.php/main/facebook_request';?>" id="signuppopup" ><img src="<?php echo $base_url;?>images/fbconnect.gif" alt="" width="64" height="20" border="0" /></a>
        </div>
...
width:102px;height:38px;
 ...
 <div class="logo"><a href="#"><img src="<?php bloginfo('template_directory'); ?>/images/logo.png" width="256" height="79"  alt="img"  border="0"/></a></div>
 
 <div class="top_choose_lang">
 <div class="tp-flags">
 <h4>CHOOSE LANGUAGE :</h4>
 <a href="#"><img src="<?php bloginfo('template_directory'); ?>/images/top_flag_1.png" width="26" height="18" alt="" class="pad-flag" border="none" /></a>
 <a href="#"><img src="<?php bloginfo('template_directory'); ?>/images/top_flag_2.png" width="26" height="18" alt="" class="pad-flag" border="none" /></a>
  <a href="#"><img src="<?php bloginfo('template_directory'); ?>/images/top_flag_3.png" width="26" height="18" alt="" class="pad-flag"border="none" /></a>
   <a href="#"><img src="<?php bloginfo('template_directory'); ?>/images/top_flag_4.png" width="26" height="18" alt="" class="pad-flag" border="none" /></a>
    <a href="#"><img src="<?php bloginfo('template_directory'); ?>/images/top_flag_5.png" width="26" height="18" alt="" class="pad-flag" border="none" /></a>
      <a href="#"><img src="<?php bloginfo('template_directory'); ?>/images/top_flag_6.png" width="26" height="18" alt="" class="pad-flag"border="none" /></a>
        <a href="#"><img src="<?php bloginfo('template_directory'); ?>/images/top_flag_7.png" width="26" height="18" alt="" class="pad-flag" border="none" /></a>
 ...
 <ul>
 <li><a href="http://localhost/casino/mypage/">Home</a></li>
  <li><a href="http://localhost/casino/bingo/">Bingo</a></li>
  <li><a href="http://localhost/casino/poker/">Poker</a></li>
  <li><a href="http://localhost/casino/scratch_cards/">Scratch Cards</a></li>
  <li><a href="http://localhost/casino/new_casino/">New Casino</a></li>
  <li><a href="http://localhost/casino/usa_play/">USA Play</a></li>
   <li><a href="http://localhost/casino/Craps/">Craps</a></li>
    <li><a href="http://localhost/casino/blog/">Blog</a></li>
 <!-- <ul>
  <li><a href="#">News</a></li>
 ...
 <?php /*?><Li> <?php echo anchor('crap/', 'Craps');?></Li><?php */?>
	...
	if(($("#username").val() == "") || ($("#username").val() == "Username") || (($("#password").val() == "Password" )|| ($("#password").val() == "" )))
	  ...
	  $.post( $("#myForm").attr("action"),
			 ...
			 function(info) {
			   ...
			   $("#emailconfirm").html("Your Account has been successfully activated. You can now log in using the username and password you choose during the register.<br/>Your Confirmation link Has Been Sent To Your Email Address");
